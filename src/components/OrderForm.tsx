...
export default function OrderForm({ pendingItem, onClear }: Props) {
  ...
  const update =
    ...
    (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) =>
      setForm((f) => ({ ...f, [field]: e.target.value }));
        ...
        // Cuando llega un item desde el modal, lo agrega al campo de productos
    useEffect(() => {
      ...
      setForm((f) => ({
        ...f,
        products: f.products
          ? `${f.products}\n${line}` // si ya hay algo, agrega en nueva línea
          : line,
      }));

      onClear(); // limpia el pendingItem para no re-agregar si el form se re-renderiza
    }, [pendingItem]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // If no Supabase configured, still show success (dev mode)
        ...
        <div style={{ maxWidth: "800px", margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: "3rem" }}>
            ...
            >
              ...
              confirmar disponibilidad y coordinar la entrega.
            </p>
          </div>
          ...
          {status === "success" ? (
            ...
            >
              ...
              <p style={{ color: "#777", fontSize: "15px" }}>
                Te contactaremos pronto al número proporcionado para confirmar
                tu pedido.
              </p>
              <button
            ...
            >
              ...
              <textarea
                ...
                placeholder="Cualquier detalle sobre tu pedido o mascota..."
                rows={2}
              ...
              >
                ...
                <a
                  href="https://wa.me/584142787453"
                  style={{ color: "#4DFFD2", textDecoration: "none" }}
                >
                  WhatsApp
                </a>
              </p>
