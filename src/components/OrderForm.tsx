...
const INITIAL: FormData = { name: '', phone: '', email: '', address: '', products: '' /*, notes: ''*/ }
        ...
        {status === 'success' ? (
          <div style={{
            ...
            <p style={{ color: '#777', fontSize: '15px' }}>
              Te contactaremos pronto al número proporcionado para confirmar tu pedido.
            </p>
            <button
          ...
          <div className="order-box" style={{ background: '#111', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '16px', padding: '2.5rem' }}>
            ...
            <p style={{ fontSize: '18px', color: '#444', textAlign: 'center', marginTop: '1rem' }}>
              También puedes escribirnos directamente por{' '}
              <a href="https://wa.me/584142787453" style={{ color: '#4DFFD2', textDecoration: 'none' }}>
                WhatsApp
              </a>
            </p>
          </div>
  ...
  return (
    <div>
      ...
      <input
        ...
        style={{
          ...inputStyle,
          borderColor: focused ? 'rgba(77,255,210,0.4)' : 'rgba(255,255,255,0.08)',
        }}
      />
    </div>
  )
